...
// 1. Configuration (Same as demo, but using dotenv) config is done functions rather than apart from them to avoid errors
...
const uploadOnCloudinary = async (localFilePath) => {
    try {
        ...
        // 4. The Cleanup Step - Critical for your server
